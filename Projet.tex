...
\fbox{\parbox{\linewidth-8\fboxrule-8\fboxsep}{Les prographes
    ...
    ainsi un bon nombre de structures discrètes mais restent des 
    structures peu étudiées. Par exemple, la conception d'un algorithme 
    efficace pour leur génération exhaustive est déjà un défi. Les 
    prographes entretiennent de fortes interactions avec l'algèbre et
    interviennent notamment dans l'étude des opérades et des PROs. Ce 
    projet propose une étude à la fois combinatoire et algébrique des 
    prographes.
}}
\bigskip
...
prographes contenant $n$ produits et $n$ coproduits (voir la
...
\begin{footnotesize}
    \begin{figure}[ht]
        ...
        \begin{tikzpicture}[scale=0.3]
            \tikzstyle{prod} = [draw, fill=blue!20, minimum size=1em]
            \tikzstyle{coprod} = [draw, fill=red!20, minimum size=1em]
            \tikzstyle{edg} = [thick]
            ...
            \draw[edg] (0,1) -- (1,2);
            \draw[edg] (0,1) -- (-1,2);
            \draw (0,1) node[coprod] {c};

            \draw[edg] (1,2) -- (0,3);
            \draw[edg] (-1,2) -- (0,3);
            \draw[edg] (0,3) -- (0,4);
            \draw (0,3) node[prod] {p};

            \draw[edg] (0,4) -- (0,5);
            \draw[edg] (0,5) -- (1,6);
            \draw[edg] (0,5) -- (-1,6);
            \draw (0,5) node[coprod] {c};

            \draw[edg] (-1,6) -- (0,7);
            \draw[edg] (1,6) -- (0,7);
            \draw[edg] (0,7) -- (0,8);
            \draw (0,7) node[prod] {p};

            %% SECOND
            \draw[edg] (6,0) -- (6,1);
            \draw[edg] (6,1) -- (9,4);
            \draw[edg] (6,1) -- (5,2);
            \draw (6,1) node[coprod] {c};

            \draw[edg] (5,2) -- (4,3);
            \draw[edg] (4,3) -- (3,4);
            \draw[edg] (4,3) -- (5,4);
            \draw (4,3) node[coprod] {c};

            \draw[edg] (3,4) -- (4,5);
            \draw[edg] (5,4) -- (4,5);
            \draw[edg] (4,5) -- (5,6);
            \draw (4,5) node[prod] {p};

            \draw[edg] (5,6) -- (6,7);
            \draw[edg] (9,4) -- (6,7);
            \draw[edg] (6,7) -- (6,8);
            \draw (6,7) node[prod] {p};

            %% TROISIEME
            \draw[edg] (14,0) -- (14,1);
            \draw[edg] (14,1) -- (17,4);
            \draw[edg] (14,1) -- (13,2);
            \draw (14,1) node[coprod] {c};

            \draw[edg] (13,2) -- (12,3);
            \draw[edg] (12,3) -- (11,4);
            \draw[edg] (12,3) -- (16,5);
            \draw (12,3) node[coprod] {c};
            ...
            \draw[edg] (17,4) -- (14,7);
            \draw[edg] (14,7) -- (14,8);
            \draw (14,7) node[prod] {p};
            \draw (16,5) node[prod] {p};

            %% QUATRIEME
            \draw[edg] (22,0) -- (22,1);
            \draw[edg] (22,1) -- (25,4);
            \draw[edg] (22,1) -- (21,2);
            \draw (22,1) node[coprod] {c};

            \draw[edg] (21,2) -- (20,3);
            \draw[edg] (20,3) -- (19,4);
            \draw[edg] (24,3) -- (20,5);
            \draw (24,3) node[coprod] {c};
            ...
            \draw[edg] (25,4) -- (22,7);
            \draw[edg] (22,7) -- (22,8);
            \draw (22,7) node[prod] {p};
            \draw (20,5) node[prod] {p};

            %% CINQUIEME
            \draw[edg] (30,0) -- (30,1);
            \draw[edg] (30,1) -- (27,4);
            \draw[edg] (30,1) -- (31,2);
            \draw (30,1) node[coprod] {c};

            \draw[edg] (31,2) -- (32,3);
            \draw[edg] (32,3) -- (33,4);
            \draw[edg] (32,3) -- (31,4);
            \draw (32,3) node[coprod] {c};

            \draw[edg] (33,4) -- (32,5);
            \draw[edg] (31,4) -- (32,5);
            \draw[edg] (32,5) -- (31,6);
            \draw (32,5) node[prod] {p};

            \draw[edg] (31,6) -- (30,7);
            \draw[edg] (27,4) -- (30,7);
            \draw[edg] (30,7) -- (30,8);
            \draw (30,7) node[prod] {p};
        \end{tikzpicture}
    \caption{Les cinq prographes contenant deux produits et deux coproduits.}
