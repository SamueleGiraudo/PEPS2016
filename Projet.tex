...
Et puis ensuite on fera un projet ANR pour enchaîner.
...
\begin{footnotesize}
    \begin{figure}[ht]
        ...
        \end{tikzpicture}
    \caption{Les cinq prographes contenant $2$ produits et $2$
      coproduit}
    \label{fig:prodcoprod}
    \end{figure}
\end{footnotesize}
\vspace{-0.8cm}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
